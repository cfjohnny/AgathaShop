...
import '/cliente/pagar_pedido/pagar_pedido_widget.dart';
...
class VerPedidoWidget extends StatefulWidget {
  const VerPedidoWidget({
    super.key,
    required this.detallePedido,
    required this.idDetallePedido,
  });

  final PedidosRecord? detallePedido;
  final DocumentReference? idDetallePedido;

  static String routeName = 'verPedido';
  static String routePath = '/verPedido';

  @override
  State<VerPedidoWidget> createState() => _VerPedidoWidgetState();
}
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 4.0, 0.0, 0.0),
                                  child: Text(
                                    'Aquí encontra los detalles de su compra ',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          font: GoogleFonts.plusJakartaSans(
