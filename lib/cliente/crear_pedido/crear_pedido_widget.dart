...
import 'crear_pedido_model.dart';
export 'crear_pedido_model.dart';

class CrearPedidoWidget extends StatefulWidget {
  const CrearPedidoWidget({super.key});

  static String routeName = 'CrearPedido';
  static String routePath = '/crearPedido';

  @override
  State<CrearPedidoWidget> createState() => _CrearPedidoWidgetState();
}

class _CrearPedidoWidgetState extends State<CrearPedidoWidget> {
  late CrearPedidoModel _model;
