...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? VerificacionDeRolWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? VerificacionDeRolWidget()
              : LoginWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: VerificacionDeRolWidget.routeName,
          path: VerificacionDeRolWidget.routePath,
          builder: (context, params) => VerificacionDeRolWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CrearPedidoWidget.routeName,
          path: CrearPedidoWidget.routePath,
          builder: (context, params) => CrearPedidoWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: HistorialWidget.routeName,
          path: HistorialWidget.routePath,
        ...
        FFRoute(
          name: PedidosActivosWidget.routeName,
          path: PedidosActivosWidget.routePath,
          builder: (context, params) => PedidosActivosWidget(
            estado: params.getParam(
              'estado',
              ParamType.String,
            ),
