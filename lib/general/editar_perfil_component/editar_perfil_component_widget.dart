...
import 'editar_perfil_component_model.dart';
export 'editar_perfil_component_model.dart';

class EditarPerfilComponentWidget extends StatefulWidget {
  const EditarPerfilComponentWidget({super.key});

  @override
  State<EditarPerfilComponentWidget> createState() =>
      _EditarPerfilComponentWidgetState();
}

class _EditarPerfilComponentWidgetState
    extends State<EditarPerfilComponentWidget> {
  late EditarPerfilComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPerfilComponentModel());
                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadDataIew =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadDataIew =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadDataIew =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              _model.uploadedFileUrl_uploadDataIew !=
                                                  ...
                                                  ? valueOrDefault<String>(
                                                      _model
                                                          .uploadedFileUrl_uploadDataIew,
                                                      'https://firebasestorage.googleapis.com/v0/b/crudmartessemana4jfcf.firebasestorage.app/o/imagenes%2FChatGPT%20Image%2017%20feb%202026%2C%2006_35_38%20p.m..png?alt=media&token=73bb7375-34e5-4137-bdea-a68e9b1396ef',
                                                    )
                                                  : valueOrDefault<String>(
                                                      currentUserPhoto,
